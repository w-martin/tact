...
#include "teflon/algorithm/RandomNumberGenerator.h"
...
protected:
    ...
    int ** z;
    /**
     * nw[i][j]: number of instances of term j assigned to topic i, size K x V
     * 
     */
    int ** Nwz;
    /**
     * nd[i][j]: number of terms in document i assigned to topic j, size M x K
     * 
     */
    int ** Nzd;
    /**
     ...
     * document number.
     * 
     * @param featureMap the FeatureMap corresponding to the given Document.
     * @param docNo the document number corresponding to the given Document.
     * 
     */
