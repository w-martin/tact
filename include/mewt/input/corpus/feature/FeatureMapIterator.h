    ...
    namespace corpus {
      ...
      namespace feature {
        ...
        public:
           ...
           * Default constructor.
           * 
           * @param iter the iterator of the internal FeatureMap data 
           * representation.
           * 
           */
           ...
           * 
           * @param other the FeatureMapIterator to compare against.
           * @return true if this FeatureMapIterator does not equal the 
           * given FeatureMapIterator, false otherwise.
           * 
           */
          bool const operator!=(FeatureMapIterator const & other) const;
          /**
